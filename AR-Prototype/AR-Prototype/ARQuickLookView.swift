...
//        context.coordinator.parent.usdzURL = test
    }
...
//            print(fileURL)
//            let fileURL2 = URL(fileURLWithPath: parent.usdzURL!)
            
            print("Bundle.main.url: \(fileURL)")
//            print("directory url: \(fileURL2)")
            let item = ARQuickLookPreviewItem(fileAt: parent.usdzURL)
